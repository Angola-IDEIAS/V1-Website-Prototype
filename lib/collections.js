...
var occupations = ['Estudante', 'Desempregado', 'Empregado em tempo partial', 'Empregado', 'Empregado autônomo'];

// helpers for Ideas collection
var industries = ["Educação","Saúde","Comércio","Agricultura/Gado","Padaria","Aplicações informáticas","Construção","Carpintaria","Outros comércios especializados","Destileria/Cervejaria","Cuidado de crianças","Vestuário","Pescaria","Produção & fabricação de alimentos","Fabricação","Alimentos e bebidas","Loja de varejo","Outros serviços"]
...
Problems.attachSchema(new SimpleSchema({
  ...
  companies_or_projects: {
    type: String,
    label: "Há uma necessidade de criação de mais empresas ou para o lançamento de projetos de comunidade",
    allowedValues: [
      "Empresas",
  ...
  solution_ideas: {
    type: String,
    label: "O que poderia ser algumas soluções possíveis que poderiam resolver este problema",
    optional: true
  },
